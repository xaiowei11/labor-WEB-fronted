// // src/components/forms/NightForm.jsx
...
// const NightForm = ({ workerCode, companyCode, batchNumber, formTypeId = 5,onSubmitSuccess }) => {
...
//   // 從子元件接收NASA-TLX量表數據
//   const handleNasaTlxDataChange = (data) => {
//     setNasaTlxData(data);
//   };
...
//       const submitData = {
//         worker_id: workerId,
//         form_type_id: formTypeId, // 第五時段表單ID
...
//           <NasaTlxScale onDataChange={handleNasaTlxDataChange} />
